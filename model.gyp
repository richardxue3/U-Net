...
def unet():
    ...
    pool3 = MaxPooling2D(pool_size = (2,2), strides = 2, padding = 'valid')(conv3_2)
    ...
    pool4 = MaxPooling2D(pool_size = (2,2), strides = 2, padding = 'valid')(conv4_2)
    ...
    #Decoding
    upsample1 = UpSampling2D(size = (2,2), interplation = 'nearest')(conv5_2)
    concat1 = np.concatenate(conv4_2, upsample1, axis = 3)
    ...
    concat2 = np.concatenate(conv3_2, upsample2, axis = 3)
    ...
    upsample3 = UpSampling2D(size = (2,2), interplation = 'nearest')(convtrans2_2)
    concat3 = np.concatenate(conv2_2, upsample3, axis = 3)
    ...
    upsample4 = UpSampling2D(size = (2,2), interplation = 'nearest')(convtrans3_2)
    concat4 = np.concatenate(conv1_2, upsample4, axis = 3)
